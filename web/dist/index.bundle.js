...
const functions = {
    ...
    loadNames: () => {
        ...
        [].forEach.call(seriesNameSpans, span => {
            ...
            fetch(`${api.show}${id}`).then(res => res.json()).then(data => {
...
frontendFunctions = __webpack_require__(0);

frontendFunctions.searchEvent();
frontendFunctions.loadNames();
frontendFunctions.prepareToRemove();
